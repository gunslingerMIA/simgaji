...
@section('title', 'Generate Gaji 13 & 14 (THR) PNS')
@section('page_title', 'Generate Gaji 13 & 14 (THR) PNS')
        ...
        <div class="col-md-8 col-lg-7">
            <div class="card shadow-sm border-0 mt-3">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <h4 class="mb-1 text-primary"><i class="fa-solid fa-gifts me-2"></i>Generate Gaji 13 & 14 (THR) PNS</h4>
                    <p class="text-muted small mb-0">Hitung dan buat daftar pembayaran THR (Gaji 14) atau Gaji 13 untuk PNS.</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info border-info border-opacity-25 bg-info bg-opacity-10 d-flex align-items-start mb-4" role="alert">
                        ...
                        <div class="small">
                            <strong>Ketentuan Perhitungan:</strong>
                            <ul class="mb-0 ps-3 mt-1">
                                <li>Komponen mengacu pada <strong>Gaji Pokok, Tunjangan Keluarga, Tunjangan Jabatan/Umum, & Tunjangan Beras</strong> dari Gaji Induk pada <strong>Bulan Dasar</strong>.</li>
                                <li><strong>Bebas Potongan IWP 1%, IWP 8%, dan BPJS Kesehatan / Ketenagakerjaan</strong> (Rp 0).</li>
                                <li><strong>PPh 21 TER Akumulatif:</strong> Bruto THR digabungkan dengan Bruto Gaji Induk di <strong>Bulan Pencairan</strong> untuk menghitung tarif TER dan potongan PPh yang proporsional.</li>
                                <li>Data yang sudah digenerate dapat dihapus/disesuaikan sebelum dikunci (misal pegawai mutasi keluar).</li>
                            </ul>
                        </div>
                    </div>

                    <form action="{{ route('gaji-tambahan-pns.store') }}" method="POST" id="formGenerate">
                        @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-check card p-3 border {{ $jenis === 'thr' ? 'border-primary bg-primary bg-opacity-10' : '' }}" style="cursor: pointer;" onclick="document.getElementById('radio_thr').checked=true; updateJenisStyle();">
                                        ...
                                        <div class="text-muted small mt-1 ms-4">Biasanya dicairkan menjelang Hari Raya (dasar gaji Februari).</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check card p-3 border {{ $jenis === 'gaji_13' ? 'border-primary bg-primary bg-opacity-10' : '' }}" style="cursor: pointer;" onclick="document.getElementById('radio_13').checked=true; updateJenisStyle();">
                                        ...
                                        <div class="text-muted small mt-1 ms-4">Biasanya dicairkan menjelang tahun ajaran baru (dasar gaji Mei/Juni).</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-light border-0 p-3 mb-4">
                            <h6 class="fw-bold text-dark mb-3"><i class="fa-solid fa-database text-info me-2"></i>2. Periode Dasar Gaji Induk (Snapshot Nominal)</h6>
                            <div class="row g-3">
                                <div class="col-md-6">
                            ...
                            <div class="form-text mt-2 small text-muted">
                                *Contoh: Untuk THR yang cair di bulan Maret, umumnya menggunakan dasar Gaji Induk bulan Februari.
                            </div>
                        </div>

                        <div class="d-flex justify-content-between pt-2">
                            <a href="{{ route('gaji-tambahan-pns.index', ['jenis' => $jenis, 'bulan_cair' => $bulanCair, 'tahun_cair' => $tahunCair]) }}" class="btn btn-light border px-4">

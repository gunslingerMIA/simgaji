...
return new class extends Migration
{
    ...
    {
        Schema::create('gaji_tambahan_pppk', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('masa_kerja_bulan')->default(12);
            $table->decimal('persen_proporsional', 5, 2)->default(100.00);
            $table->decimal('gaji_pokok_dasar', 15, 2)->default(0);
    ...
    {
        Schema::dropIfExists('gaji_tambahan_pppk');
    }
};
